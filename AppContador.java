 ...
 * @author Cliente
 */
public class AppContador extends javax.swing.JFrame {

    /**
     * Creates new form AppContador
     */
    public AppContador() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppContador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AppContador().setVisible(true);
            }
        });
    }
